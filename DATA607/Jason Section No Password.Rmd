...
```{r, include=FALSE}
SEER = dbConnect(MySQL(), user="root", password="", host="", dbname="cancer") 
cancercasessummary<-dbGetQuery(SEER, "SELECT * FROM cancer_cases_summary")
joinedtab<-dbGetQuery(SEER, "SELECT * FROM cancer_cases_summary INNER JOIN cancer_registry_master ON cancer_cases_summary.CancerRegistryID=cancer_registry_master.CAncerRegistryID")
```
...
#Bulgaria2011AllButSkin<-Bulgaria2011ABSM
...
#Bulgaria2011ABSDemo<-as.data.frame(Bulgaria2011AllButSkin[c(6:23)])
