...
```{r test1, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
...
```{r test2, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test3, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test4, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test5, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test6, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test7, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test8, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
...
```{r test9, fig.width = 10, fig.height = 6, message=FALSE, warning=FALSE}
# Perform Test Queries for each Table
